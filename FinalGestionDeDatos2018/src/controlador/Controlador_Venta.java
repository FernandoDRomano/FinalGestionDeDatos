...
public class Controlador_Venta {
    ...
    public static void agregarClienteAlaVenta(BuscarCliente vista, NuevaVenta venta){
        ...
        if (fila > -1) {
            ...
            String telefono = vista.getTabla_Cliente().getModel().getValueAt(fila, 3).toString();
            //Creo el cliente
    ...
    public static void AltaVenta(NuevaVenta vista) {
        venta = new Venta();
        cliente = new Cliente();
        empleado = new Empleado();
                try {
                    ...
                    JOptionPane.showMessageDialog(null, "Venta Grabada con Exito!");
                    vista.dispose();
                } catch (Exception ex) {
