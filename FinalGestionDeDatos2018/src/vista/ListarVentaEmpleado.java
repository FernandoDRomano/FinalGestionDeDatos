 ...
 * @author fernando
 */
public class ListarVentaEmpleado extends javax.swing.JDialog {
    ...
    public ListarVentaEmpleado(java.awt.Frame parent, boolean modal) throws SQLException {
        super(parent, modal);
        initComponents();
        ...
        tabla_Ventas.setModel(modeloVentas);
        Controlador_Venta.cargarEmpleados(this);
    ...
    private void initComponents() {
        ...
        setTitle("Ventas Realizadas por Empleado");

        jPanel1.setBackground(java.awt.Color.white);

        jPanel2.setBackground(java.awt.Color.white);
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "Ventas Realizadas", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 1, 12))); // NOI18N
    ...
    private void tabla_EmpleadosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabla_EmpleadosMouseClicked
        try {
            ...
            if (fila > -1) {
                ...
                Controlador_Venta.cargarVentaxEmpleado(this);
            }
        } catch (SQLException ex) {
            Logger.getLogger(ListarVentaEmpleado.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void txt_BuscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_BuscarKeyReleased
        ...
        try {
            Controlador_Venta.filtrarEmpleados(this, cadena);
        } catch (SQLException ex) {
            Logger.getLogger(ListarVentaEmpleado.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListarVentaEmpleado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ListarVentaEmpleado dialog = new ListarVentaEmpleado(new javax.swing.JFrame(), true);
