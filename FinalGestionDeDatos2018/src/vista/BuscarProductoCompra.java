 ...
 * @author Fernando
 */
public class BuscarProductoCompra extends javax.swing.JDialog {

    private DefaultTableModel modelo = new DefaultTableModel();
    private NuevaCompra compra;
    
    public BuscarProductoCompra(java.awt.Frame parent, boolean modal, NuevaCompra compra) throws SQLException {
        super(parent, modal);
        initComponents();
        this.compra = compra;
        Controlador_Compra.CargarTodosLosProductos(this);
    ...
    private void btn_AgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_AgregarActionPerformed
        Controlador_Compra.agregarProductoAlPedido(this, compra);
    ...
    private void txt_BuscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_BuscarKeyReleased
        try {
            Controlador_Compra.CargarTodosLosProductos(this, txt_Buscar.getText());
        } catch (SQLException ex) {
            Logger.getLogger(BuscarProductoCompra.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public NuevaCompra getCompra() {
        return compra;
    }

    public void setCompra(NuevaCompra compra) {
        this.compra = compra;
    }
