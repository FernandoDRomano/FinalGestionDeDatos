 ...
 * @author fernando
 */
public class ListarCompraEmpleado extends javax.swing.JDialog {
    ...
    public ListarCompraEmpleado(java.awt.Frame parent, boolean modal) throws SQLException {
        super(parent, modal);
        initComponents();
        ...
        Controlador_Compra.cargarEmpleados(this);
    ...
    private void initComponents() {
        ...
        setTitle("Compras Realizadas por Empleado");

        jPanel1.setBackground(java.awt.Color.white);

        jPanel2.setBackground(java.awt.Color.white);
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "Compras Realizadas", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 1, 12))); // NOI18N
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "Lista de Empleados", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 1, 12))); // NOI18N
    ...
    private void tabla_EmpleadosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabla_EmpleadosMouseClicked
        try {
            ...
            if (fila > -1) {
                ...
                Controlador_Compra.cargarCompraxEmpleado(this);
            }
        } catch (SQLException ex) {
            Logger.getLogger(ListarCompraEmpleado.class.getName()).log(Level.SEVERE, null, ex);
        }
    }//GEN-LAST:event_tabla_EmpleadosMouseClicked

    private void btn_FiltrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_FiltrarActionPerformed
        try {
            Controlador_Compra.filtrarFechaCompras(this);
        } catch (SQLException ex) {
            Logger.getLogger(ListarCompraEmpleado.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void btn_LimpiarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_LimpiarActionPerformed
        Controlador_Compra.LimpiarFechas(this);
    }//GEN-LAST:event_btn_LimpiarActionPerformed

    private void txt_BuscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_BuscarKeyReleased
        String cadena = txt_Buscar.getText();
        try {
            Controlador_Compra.filtrarEmpleados(this, cadena);
        } catch (SQLException ex) {
            Logger.getLogger(ListarCompraEmpleado.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListarCompraEmpleado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ListarCompraEmpleado dialog = new ListarCompraEmpleado(new javax.swing.JFrame(), true);
