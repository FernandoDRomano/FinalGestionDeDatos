 ...
 * @author fernando
 */
public class ListarCompra extends javax.swing.JDialog {
    ...
    public ListarCompra(java.awt.Frame parent, boolean modal) throws SQLException {
        super(parent, modal);
        initComponents();
        ...
        Controlador_Compra.cargarCompras(this);
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "Detalle de la Compra", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 1, 12))); // NOI18N
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "Listado de Compras", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 1, 12))); // NOI18N
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(btn_Exportar, javax.swing.GroupLayout.PREFERRED_SIZE, 170, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
    ...
    private void tabla_PedidosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabla_PedidosMouseClicked
        try {
            ...
            if (fila > -1) {
                ...
                System.out.println("ID PEDIDO: " + compra.getIdCompra());
                Controlador_Compra.detallesDeCompra(this);
            }
    ...
    private void txt_BuscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_BuscarKeyReleased
        ...
        try {
            Controlador_Compra.filtrarCompras(this, cadena);
        } catch (SQLException ex) {
            Logger.getLogger(ListarCompra.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void btn_ExportarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_ExportarActionPerformed
        try {
            Controlador_Compra.exportarPDF(this);
        } catch (SQLException ex) {
            Logger.getLogger(ListarCompra.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ListarCompra dialog = new ListarCompra(new javax.swing.JFrame(), true);
